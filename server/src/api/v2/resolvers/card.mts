...
import { HoloType, Resolvers } from "../../../generated/graphql.mjs";

function replaceSlashes(value: any) {
    return value === '-' ? null : value;
}

function replaceHoloType(value: string) {
    switch (value) {
        case "Bubble": {
...
export function dbCardToGraphCard(c: any) {
    return {
        id: c._id.toString(),
